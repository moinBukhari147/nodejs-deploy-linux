	...
	module.exports = {
	  apps : [{
	    ...
	    max_memory_restart: "200M",
		  ...
		  GOOGLE_CLIENT_SECRET: 'client_secret',    # if using the google oauth
...
- You can follow the all the steps of or the desired steps accoridng to you need. Now the database has been configured we are reaady to start the process.
...
```
  rename the .js to .cjs if you using the type: module i.e (import export method)
...
- Add the follwoing the code that we have added in the default in this file:
  ```bash
    server {
	listen 80 ;
	server_name yourdomain.com;					# replace this with the domain
	# Any ohter your nginx configuration 
